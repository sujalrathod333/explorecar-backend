...
import {testimonialStyles as styles} from '../assets/FRONTEND/dummyStyles';
import testimonials from '../assets/FRONTEND/Testimonialdata'
  ...
  return (
   ...
   <div className={styles.container}>
    <div className={styles.innerContainer}>
      <div className={styles.headerContainer}>
        <div className={styles.badge}>
         <FaCar className={`${styles.quoteIcon} mr-2`} />
            <span className={styles.badgeText}>What Our Clients Say</span>
      </div>
      ...
      <p className={styles.subtitle}>Discover why our customers love our premium car rental service</p>
      </div>
      ...
      <div className={styles.ratingContainer}>
        {[...Array(5)].map((_, i)=>(
            <FaStar key={i} className={
                `${
                    i < t.rating ? styles.accentText : "text-grey-700"
                } ${styles.star}`
            } size={18} />
        ))}
      </div>
       ...
       <div className={styles.statsContainer}>
        <div className={styles.statsGrid}>
          ...
          <div className={styles.statItem}>
            ...
            <div className={styles.statLabel(styles.statColors.label[1])}>Luxury Vehicles</div>
       ...
       {/* CTA BUTTON */}
        ...
        <div className={styles.ctaContainer}>
          <h2 className={styles.ctaTitle}>Ready for Your Premium Experiences?</h2>
          <p className={styles.ctaText}>
             Join thousands of satisfied customers and book your luxury car today!
          </p>
