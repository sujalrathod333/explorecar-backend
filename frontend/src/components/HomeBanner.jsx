...
import img1 from '../assets/FRONTEND/hero.png';
import { heroStyles as styles } from '../assets/FRONTEND/dummyStyles';
      ...
      >
        ...
        <div className={styles.ctaContainer}>
          <div className={styles.ctaCard}>
            <div>
            <p className={styles.subtitle}>ExploreCar</p>
            <h3 className={styles.title}>Next-gen fleet. Instant drive.</h3>
            <p className={styles.description}>Rent your dream car. Transparent pricing. Book in Seconds</p>
            </div>
